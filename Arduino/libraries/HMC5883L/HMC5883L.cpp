...
int HMC5883L::SetScale(float gauss)
{
	...
	else if(gauss == (float)1.3)
	{
		regValue = 0x01;
		m_Scale = 0.92;
	}
	else if(gauss == (float)1.9)
	{
		regValue = 0x02;
		m_Scale = 1.22;
	}
	else if(gauss == (float)2.5)
	{
		regValue = 0x03;
		m_Scale = 1.52;
	}
	else if(gauss == (float)4.0)
	{
		regValue = 0x04;
		m_Scale = 2.27;
	}
	else if(gauss == (float)4.7)
	{
		regValue = 0x05;
		m_Scale = 2.56;
	}
	else if(gauss == (float)5.6)
	{
		regValue = 0x06;
		m_Scale = 3.03;
	}
	else if(gauss == (float)8.1)
	{
		regValue = 0x07;
		m_Scale = 4.35;
	}
